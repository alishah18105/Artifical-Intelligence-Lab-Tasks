# Does the agent ever stop? If no, can you make it stop? Is your program rational? 

# Does the agent ever stop?: According to previous logic, No agent keeps moving right or left.
# If no, can you make it stop?: Yes, I have made the agent stop when all rooms are clean.
# Is your program rational?: Yes, the program is rational as it cleans all rooms and stops when done.
...
if __name__ == "__main__":
    vcagent = VacuumAgent()
    env = NRoomVacuumCleanerEnvironment(vcagent,7)
    env.executeStep()
